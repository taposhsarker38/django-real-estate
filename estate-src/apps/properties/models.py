...
class Property(TimeStampUUIDModel):
    ...
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=180,default="1216")
    street_address = models.CharField(verbose_name=_("Street Address"),max_length=150,default="ODCL Corporate Dhaka")
    ...
    property_type = models.CharField(verbose_name=_("Property Type"),max_length=50,choices=PropertyType.choices,default=PropertyType.HOUSE)
    cover_photo = models.ImageField(verbose_name=_("Main Photo"),default="/property_default.png",null=True,blank=True)
    photo1 = models.ImageField(default="/property_default.png",null=True,blank=True)
    photo2 = models.ImageField(default="/property_default.png",null=True,blank=True)
    photo3 = models.ImageField(default="/property_default.png",null=True,blank=True)
    photo4 = models.ImageField(default="/property_default.png",null=True,blank=True)
