...
class Profile(TimeStampUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+8801767272578"
    )
    about_me = models.TextField(
        verbose_name=_("About Me"), default="say something about yourself"
    )
    lincence = models.CharField(
        verbose_name=_("Real Estate Lincence"), max_length=20, blank=True, null=True
    )
    ...
    top_agent = models.BooleanField(
        verbose_name=_("Top Agent"), default=False, help_text=_("Are you an Top agent?")
    )
